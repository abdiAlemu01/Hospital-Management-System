 ...
 * Features: Multiple types, icons, dismissible, animations
 */
const Alert = ({ type = "error", message, onClose }) => {
  ...
  return (
    <div
      className={`${style.container} rounded-xl p-4 flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300`}
      role="alert"
    >
      <div className={`${style.icon} flex-shrink-0`}>{getIcon()}</div>
